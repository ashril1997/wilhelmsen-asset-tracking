<!--Menu bar code start here-->
    ...
    @endif 
<div class="container">
    <header>Delivered Item</header>
                <form class="reportform" action="{{ url('delivered_asset_Searching')}}" method="post">
                    {{ csrf_field() }}
                            ...
                            <div class="input-section">
                                <label>Month</label>
                                        <select name="get_month" class="get_month">
                                            ...
                                            @else
                                                <option value='{{$selectedMonthValue}}'>{{$selectedMonth}}</option>
                                            @endif
                    ...
                    <table  class="content-table" id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="#" class="PromoteBtn redeliver" data-name="{{$reporting_info->SerialNumber}}" data-serial_number="{{$reporting_info->SerialNumber}}">
                                        Redeliver
                                    </a>&nbsp;
                                </td> 
    ...
    <script>
        ...
        $('.redeliver').click( function(){
            ...
            var _url = "redeliver_asset/"+serial_number;
            swal({
                title: "Are you sure?",
                text: "Do you want to redeliver this asset ("+name+") ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal("Asset have been redeliver!", {
                    icon: "success",
                    });
                } else {
